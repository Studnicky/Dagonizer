 ...
 *
 * Captures which modality resolved (`source`), whether a secondary lookup was used,
...
export const GeoResolutionSchema = {
  '$id': 'https://noocodec.dev/schemas/cartographer/GeoResolution',
  '$schema': 'https://json-schema.org/draft/2020-12/schema',
  'type': 'object',
  'required': ['source', 'secondaryLookupUsed', 'timezone', 'country', 'countryName', 'locale', 'region', 'locality', 'lat', 'lng', 'status', 'weight'],
  'properties': {
    'source':              { 'type': 'string', 'enum': ['coords', 'locale', 'code', 'ip', 'none', 'address', 'phone'] },
    'secondaryLookupUsed': { 'type': 'boolean' },
...
export class GeoResolutionBuilder {
  ...
  public static from(partial: Partial<GeoResolutionInput>): GeoResolution {
    return {
      ...
      'secondaryLookupUsed': partial.secondaryLookupUsed ?? DEFAULT_GEO_RESOLUTION.secondaryLookupUsed,
