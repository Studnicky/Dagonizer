...
description: 'GrpcStore extends BaseStore and implements RemoteStore. Network methods print to stdout instead of making real gRPC calls. The in-memory data map is identical in behaviour to a real remote store.'
seeAlso:
