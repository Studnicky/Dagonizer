...
Google AI Studio REST embedder for [@noocodex/dagonizer](https://npmjs.com/package/@noocodex/dagonizer).
Targets `text-embedding-004` (768 dimensions) by default.

## Install

```bash
npm install @noocodex/dagonizer @noocodex/dagonizer-embedder-gemini-api
```
