 ...
 * `SCATTER_PROGRESS_KEY` / `WORKSET_PROGRESS_KEY`. This module is the canonical
 * home so `runtime/`, `checkpoint/`, and the engine import the keys inward.
 */
...
export const ProgressKeySchema = {
  ...
  'type': 'string',
  'enum': ['__dagonizer_scatter_progress__', '__dagonizer_workset_progress__'],
} as const;
