 ...
 * instance via the canonical TS type at `lifecycle/DAGLifecycleStateType.ts`;
 ...
 * lives at `src/lifecycle/DAGLifecycleStateType.ts` and uses `Error`
 ...
 */
export type DAGLifecycleStateDataType = FromSchema<typeof DAGLifecycleStateSchema>;
